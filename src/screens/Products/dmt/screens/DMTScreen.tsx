...
export default function DMTScreen({navigation}: any) {
    ...
    return (
        <View className="flex-1 bg-white px-5 py-6">
            {/* HEADER */}
            <View>
                <Text className="text-3xl font-semibold text-primary_gray">
                    Mudra Remit
                </Text>
                <Text className="text-secondary_gray mt-1 leading-5 text-[13px]">
                    As per RBI guidelines, please enter correct sender details. Incorrect
                    information may lead to compliance issues.
                </Text>
            </View>
    ...
    "
            ...
            {/* TITLE */}
            <Text className="text-lg font-semibold text-primary_gray mt-6 mb-3">
                Transaction History
            </Text>
