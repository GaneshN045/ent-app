      ...
      >
        <View className="p-5">
          ...
          <View className="bg-white rounded-2xl shadow-md border border-gray-100 p-5">
            {/* Wallet From */}
            <Text className="text-gray-700 font-semibold mb-1">Wallet Type From *</Text>
            <TextInput
              value={walletFrom}
            ...
            {/* Wallet To */}
            <Text className="text-gray-700 font-semibold mb-1">Wallet Type To *</Text>
            <TextInput
              value={walletTo}
            ...
            {/* Transfer Amount */}
            <Text className="text-gray-700 font-semibold mb-1">Transfer Amount *</Text>
            <TextInput
              value={amount}
