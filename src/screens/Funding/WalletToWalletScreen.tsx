...
const InputField = React.memo(({ label, value, onChangeText, onBlur, error, touched }: InputFieldProps) => (
  <View>
              ...
              <View className="bg-white rounded-2xl shadow-md border border-gray-100 p-5">
                ...
                <View className="mb-6">
                  ...
                  <View className="items-center my-1 mt-4 z-10">
                    <TouchableOpacity
                      activeOpacity={0.85}
                      onPress={() => toggleWallets(setFieldValue, values.walletFrom, values.walletTo)}
                  ...
                  {((touched.walletFrom && errors.walletFrom) || (touched.walletTo && errors.walletTo)) && (
