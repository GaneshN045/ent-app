...
export default function ComingSoonScreen() {
  ...
  return (
    <View className="flex-1 bg-white items-center pt-[40%] px-10">
      ...
      {/* Title */}
      <Text className="text-3xl font-extrabold text-gray-800 tracking-tight mb-3">Coming Soon</Text>

      {/* Subtitle */}
      <Text className="text-gray-500 text-center text-base leading-6 mb-10">
        We're crafting something new and refined. Stay tuned for the next update.
      </Text>
